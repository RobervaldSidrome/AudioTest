...
public class DisplayUtil {
	...
	public static int heightScreenDefault = 1024;
	public static int widthScreenDefault = 600;
	...
	public static boolean setWidthHeightByHeight(final View view) {
		...
		if (view != null) {
			...
			if (param instanceof ViewGroup.LayoutParams) {
				...
				return true;
			} else if (view.getParent() instanceof ViewPager && param instanceof ViewPager.LayoutParams) {
